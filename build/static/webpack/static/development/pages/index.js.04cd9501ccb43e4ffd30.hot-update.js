...
class App extends react__WEBPACK_IMPORTED_MODULE_5___default.a.Component {
  ...
  componentDidMount() {
    Object(_services___WEBPACK_IMPORTED_MODULE_13__["getCities"])().then(({
      ...
      for (let value in _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_1___default()(oi)) {
        console.log(value); //data[key].find(this.gett);
      }
...
//# sourceMappingURL=index.js.04cd9501ccb43e4ffd30.hot-update.js.map