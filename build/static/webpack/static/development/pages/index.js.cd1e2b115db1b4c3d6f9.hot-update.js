...
class App extends react__WEBPACK_IMPORTED_MODULE_5___default.a.Component {
  ...
  componentDidMount() {
    Object(_services___WEBPACK_IMPORTED_MODULE_13__["getCities"])().then(({
      ...
      for (let key in _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_1___default()(data)) {
        console.log(key); //data[key].find(this.gett);
      }
...
//# sourceMappingURL=index.js.cd1e2b115db1b4c3d6f9.hot-update.js.map