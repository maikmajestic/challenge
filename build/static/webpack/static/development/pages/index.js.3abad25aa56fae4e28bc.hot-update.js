...
class App extends react__WEBPACK_IMPORTED_MODULE_5___default.a.Component {
  constructor(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_4__["default"])(this, "updateMousePosition", ev => {
      let left = ev.target.offsetLeft;
      left < 0 ? left = 0 : left = ev.target.offsetLeft;
      this.setState({
        mousePosition: ev.target.offsetLeft
      });
    });
...
//# sourceMappingURL=index.js.3abad25aa56fae4e28bc.hot-update.js.map