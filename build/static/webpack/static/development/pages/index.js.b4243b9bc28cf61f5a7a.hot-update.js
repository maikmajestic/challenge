...
class App extends react__WEBPACK_IMPORTED_MODULE_3___default.a.Component {
  ...
  componentDidMount() {
    Object(_services___WEBPACK_IMPORTED_MODULE_11__["getCities"])().then(({
      ...
      let cit = {};
      cit = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(data);
      console.log(oi.data.length);
      let ss = data["Mexico"];
      ss.find(this.gett);
...
//# sourceMappingURL=index.js.b4243b9bc28cf61f5a7a.hot-update.js.map