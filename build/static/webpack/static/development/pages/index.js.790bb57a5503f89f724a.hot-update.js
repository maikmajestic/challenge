...
class App extends react__WEBPACK_IMPORTED_MODULE_4___default.a.Component {
  ...
  componentDidMount() {
    Object(_services___WEBPACK_IMPORTED_MODULE_12__["getCities"])().then(({
      ...
      let xx = {};
      let vf = [];
      cit = _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_2___default()(data);
      oi = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(data);

      for (let xk in oi) {
        console.log(oi[xk]);
        xx[oi[xk]] = cit[xk];
        console.log(oi[xk].find(this.gett));
      }
...
//# sourceMappingURL=index.js.790bb57a5503f89f724a.hot-update.js.map