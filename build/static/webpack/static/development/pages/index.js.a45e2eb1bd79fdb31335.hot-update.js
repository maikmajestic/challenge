...
class App extends react__WEBPACK_IMPORTED_MODULE_3___default.a.Component {
  ...
  componentDidMount() {
    Object(_services___WEBPACK_IMPORTED_MODULE_11__["getCities"])().then(({
      ...
      console.log(data);
      let oi = {};
      console.log(_babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_1___default()(data));
      let ss = data["Mexico"];
      ss.find(this.gett);
...
//# sourceMappingURL=index.js.a45e2eb1bd79fdb31335.hot-update.js.map